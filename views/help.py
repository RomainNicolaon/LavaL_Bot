...
class View(Parent):
	...
	def gen_embeds(self):
		options, embeds = [], []
		options.append(discord.SelectOption(label="Accueil", description="Afficher la page d'accueil.", emoji='👋'))
	...
	async def quit(self, interaction : discord.Interaction):
		...
		await self.ctx.message.add_reaction("<a:yes_animated:844992841938894849>")
